...
class Oxygen_VSB_SuperBox extends CT_Component{
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        // scaling
        $superbox_secondary_scale_start  = $params['superbox_secondary_scale_start'];
        $superbox_secondary_scale_finish = $params['superbox_secondary_scale_finish'];
        $superbox_primary_scale_start    = $params['superbox_primary_scale_start'];
        $superbox_primary_scale_finish   = $params['superbox_primary_scale_finish'];
        ...
        // sliding
        if ($params['superbox_secondary_slide_direction']) {
        ...
        if ($params['superbox_primary_slide_direction']) {
        ...
        ?>
            ...
            <?php echo $params['selector']; ?> .oxy-superbox-primary {
                ...
                : <?php echo $params['superbox_transition_duration']; ?>;
            }

            <?php echo $params['selector']; ?> .oxy-superbox-secondary {
                <?php $this->output_single_css_property("opacity", $params['superbox_secondary_opacity_start']); ?>
                <?php echo $superbox_secondary_initial_css; ?>
                <?php echo $superbox_secondary_scale_start_transform_css; ?>
            }

            <?php echo $params['selector']; ?>:hover .oxy-superbox-secondary {
                <?php $this->output_single_css_property("opacity", $params['superbox_secondary_opacity_finish']); ?>
                <?php echo $superbox_secondary_hover_css; ?>
                <?php echo $superbox_secondary_scale_finish_transform_css; ?>
            }

            <?php echo $params['selector']; ?> .oxy-superbox-primary {
                <?php $this->output_single_css_property("opacity", $params['superbox_primary_opacity_start']); ?>
                <?php echo $superbox_primary_initial_css; ?>
                <?php echo $superbox_primary_scale_start_transform_css; ?>
            }

            <?php echo $params['selector']; ?>:hover .oxy-superbox-primary {
                <?php $this->output_single_css_property("opacity", $params['superbox_primary_opacity_finish']); ?>
                <?php echo $superbox_primary_hover_css; ?>
                <?php echo $superbox_primary_scale_finish_transform_css; ?>
            }
