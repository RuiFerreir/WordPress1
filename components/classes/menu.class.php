...
Class Oxy_Nav_Menu extends CT_Component {
	...
	function add_shortcode( $atts, $content ) {
		...
		if ( $options['dropdowns'] == "on" ) {
			$options['classes'] .= " oxy-nav-menu-dropdowns";
		}

		if ( $options['menu_dropdown_arrow'] == "on" ) {
			$options['classes'] .= " oxy-nav-menu-dropdown-arrow";
		}

		if ( $options['menu_responsive_dropdowns'] == "on" ) {
			$options['classes'] .= " oxy-nav-menu-responsive-dropdowns";
		}

		if ( $options['menu_flex_direction'] == "column" ) {
			$options['classes'] .= " oxy-nav-menu-vertical";
		}

		ob_start();
		
		?><div id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>"><div class='oxy-menu-toggle'><div class='oxy-nav-menu-hamburger-wrap'><div class='oxy-nav-menu-hamburger'><div class='oxy-nav-menu-hamburger-line'></div><div class='oxy-nav-menu-hamburger-line'></div><div class='oxy-nav-menu-hamburger-line'></div></div></div></div><?php 
	...
	function menu_settings() { 
		...
		<div class="oxygen-sidebar-flex-panel"
			...
			<div ng-if="isShowTab('navMenu','responsive')">
				...
				<?php $oxygen_toolbar->media_queries_list_with_wrapper("menu_responsive", __("Mobile Menu / Toggle Below","oxygen"), true); ?>
