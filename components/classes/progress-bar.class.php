...
class Oxygen_VSB_Progress_Bar extends CT_Component{
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        if ($params['progress_bar_stripes'] == "true") {
        ...
        if ($params['progress_bar_stripes'] == "false") {
            $stripecss = 'background-image: none;';
        }

        $animation_css = array();

        if ($params['progress_bar_animation_stripes'] == "true") {
        ...
        if ($params['progress_bar_animation_stripes'] == "false") {
            $animation_css['stripes'] = "none 0s paused";
        }

        if ($params['progress_bar_animate_width'] == "true") {
        ...
        if ($params['progress_bar_animate_width'] == "false") {
        ...
        <?php echo $params["selector"]; ?> .oxy-progress-bar-background {
            <?php $this->output_single_css_property("background-color", $params['progress_bar_background_color']); ?>
            <?php echo $stripecss; ?>
            <?php $this->output_single_css_property("animation", $animation_css['stripes']); ?>
        }
        ...
        <?php echo $params["selector"]; ?> .oxy-progress-bar-progress {
            <?php $this->output_single_css_property("background-color", $params['progress_bar_bar_color']); ?>
            <?php $this->output_single_css_property("padding", $params['progress_bar_bar_padding'], $this->get_css_unit('progress_bar_bar_padding', $params, $defaults)); ?>
            <?php echo $stripecss; ?>
