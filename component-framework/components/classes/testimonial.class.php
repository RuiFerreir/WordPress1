...
class Oxygen_VSB_Testimonial extends CT_Component {
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        ob_start();
            ...
            $margincss  = "";
            $spacing    = $params['testimonial_image_spacing'];

            if ($params["testimonial_layout"]=='vertical') {
                
                $margincss = "margin:0;";
                $spacing = isset($params['testimonial_image_spacing']) ? $params['testimonial_image_spacing'] : $defaults['testimonial_image_spacing'];

                if ($params["testimonial_image_position"]=='bottom') {
            ...
            <?php } 
            else if ($params["testimonial_layout"]=='horizontal') { ?>
            <?php echo $params["selector"]; ?> {
                flex-direction: row;
                align-items: center;
            }
            <?php }
            if ($params['testimonial_image_position'] == 'top' ) { ?>
            <?php echo $params["selector"]; ?> .oxy-testimonial-photo-wrap {
                order: 1;
            }
            <?php } 
            else if ($params['testimonial_image_position'] == 'bottom') { ?>
            <?php echo $params["selector"]; ?> .oxy-testimonial-photo-wrap {
                order: 3;
            }    
            <?php } ?>
            ...
            <?php echo $params["selector"]; ?> .oxy-testimonial-content-wrap {
                <?php $this->output_single_css_property("align-items", $flexalign); ?>
                <?php $this->output_single_css_property("text-align", $textalign); ?>
            }
