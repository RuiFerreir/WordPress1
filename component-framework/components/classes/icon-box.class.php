...
class Oxygen_VSB_Icon_Box extends CT_Component{
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        if ($params["icon_box_icon_position"]=='left' || $params["icon_box_icon_position"]=='right') {
        ...
        else if (isset($params['icon_box_content_alignment']) || $params["icon_box_icon_position"]=='top' || $params["icon_box_icon_position"]=='bottom'){
        ...
        ?> 
            ...
            <?php echo $params["selector"]; ?> {
                <?php $this->output_single_css_property("text-align", $params['icon_box_content_alignment']); ?>
                <?php $this->output_single_css_property("flex-direction", $icon_position_flex_direction); ?>
            }

            <?php echo $params["selector"]; ?> .oxy-icon-box-icon {
                <?php echo $iconmargincss; ?>
                <?php $this->output_single_css_property("align-self", $icon_vertical_alignment_align_self); ?>
            }
            ...
            <?php $max_size = $media_queries_list[$params['icon_box_vertical_layout_below']]['maxSize']; 
