...
class Oxygen_VSB_Gallery extends CT_Component {
    ...
    function get_from_media_library($ids) {
    ...
    function generate_css() {
        ...
        <?php } ?>
            ...
            .oxy-gallery-captions .oxy-gallery-item .oxy-gallery-item-contents figcaption:not(:empty) {
                ...
                padding: 1em;
                color: <?php echo $this->param_array['caption_color']; ?>;  /* caption text color */
                font-weight: bold;
    ...
    function shortcode($atts) {
        ...
        $options = ($atts['preview']!='true') ? $this->set_options( $atts ) : $atts;
        ...
        $gallery_images = $this->get_from_media_library($image_ids);
                ...
                <?php foreach ($gallery_images as $gallery_image) {
                    ...
                    <?php echo "<".$linktag.$href; ?> class='oxy-gallery-item'>
                        <div class='oxy-gallery-item-sizer'>
                            ...
                            <figure class='oxy-gallery-item-contents' style='background-image: url(<?php echo $gallery_image["url"]; ?>);'>
        ...
        if ($this->param_array['lightbox'] == 'yes' && $this->param_array['link'] == 'yes' && $atts['preview'] == 'true') { ?>
            <script type="text/javascript">
                setTimeout(function() {
        ...
        // frontend 
        if ($this->param_array['link'] == 'yes' && $this->param_array['lightbox'] == 'yes' && $atts['preview'] != 'true') { ?>
            <script type="text/javascript">
                jQuery('.oxy-gallery').photoSwipe('.oxy-gallery-item-contents');
            </script>
        <?php } 
